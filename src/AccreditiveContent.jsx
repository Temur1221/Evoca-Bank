    ...
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-8 text-gray-800">
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
          Փաստաթղթային ակրեդիտիվը (Letter of Credit կամ L/C) մեր գրավոր պարտավորությունն է (որը թողարկվում է գնորդի հանձնարարությամբ ի հաշիվ վաճառողի) վճարելու որոշակի գումար ապրանք վաճառողին՝ վերջինիս կողմից ակրեդիտիվի պայմաններին համապատասխան փաստաթղթեր ներկայացնելու դեպքում։
        </p>
        <p className="text-gray-700 text-sm sm:text-base leading-relaxed">
      ...
      <div className="space-y-3 pt-2">
        ...
        <p className="text-gray-700 text-sm sm:text-base leading-relaxed pt-2">
          Փաստաթղթային ակրեդիտիվների թողարկման վերաբերյալ լրացուցիչ տեղեկություններ և խորհրդատվություն ստանալու համար կարող եք դիմել մեր Գլխամասային գրասենյակ՝ «Միջազգային և արտարժութային գործառնություններ» բաժին։
        </p>
      </div>
