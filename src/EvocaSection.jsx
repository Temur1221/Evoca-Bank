...
export default function EvocaSection() {
  ...
  useEffect(() => {
    const fetchCards = async () => {
      try {
        // Firebase Collection-ի անունը՝ "Evoca Cards"
